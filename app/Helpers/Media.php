...
class Media
{
    ...
    public static function findImageByName($fileName, $parentId){
        return MediaModel::where('parent', $parentId)->where('file_name',$fileName)->first()->id;
    }
    ...
    public static function insertVideoMedia($uploadRootDir, $pathAbsolute, $pathRelative, $fileName, $parentId){
		$m = new MediaModel;
		$m->name = $fileName;
		$m->file_name = $fileName;
		$m->is_file =1;
