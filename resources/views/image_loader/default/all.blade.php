<picture {{$attribute ?? ''}}>
	...
	<img loading="{{isset($noLazyLoad) && $noLazyLoad == 1 ? 'auto':'lazy'}}" src="{%IMGV2.itemImageShow.img.-1%}" data-src="{%IMGV2.itemImageShow.img.-1%}" title="{%IMGV2.itemImageShow.img.title%}" alt="{%IMGV2.itemImageShow.img.alt%}" class="img-fluid">
</picture>
