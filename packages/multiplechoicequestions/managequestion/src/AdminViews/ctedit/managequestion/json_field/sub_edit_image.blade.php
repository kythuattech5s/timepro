...
<div class="<?php echo $idfile; ?>">
	...
	<div class="btnadmin">
		<a href="{{$admincp}}/media/view?istiny=<?php echo $idfile ?>&callback=ELEMENTOR_MANAGE_QUESTION_PROVIDER.callbackImage" class="btn iframe-btn" type="button">Browse File ...</a>
	</div>
	<div class="btnadmin">
