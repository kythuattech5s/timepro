...
use Tech5sShoppingCart\Tech5sCart\Calculation\DefaultCalculator;
use Tech5sShoppingCart\Tech5sCart\Contracts\Buyable;
use Tech5sShoppingCart\Tech5sCart\Contracts\Calculator;
use Tech5sShoppingCart\Tech5sCart\Exceptions\InvalidCalculatorException;
...
class CartItem implements Arrayable, Jsonable
{
     ...
     *
     * @param \Tech5sShoppingCart\Tech5sCart\Contracts\Buyable $item
     *
     * @return void
     */
    ...
    public function __get($attribute)
    {
        ...
        $class = new ReflectionClass(config('tech5sCart.calculator', DefaultCalculator::class));
