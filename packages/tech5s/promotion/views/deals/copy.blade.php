...
@section('css')
<link rel="stylesheet" type="text/css" href="{{ asset('__tech5sPromotion/css/deal.css') }}">
@endsection
@section('main')
<div class="row">
    <div class="col-lg-12">
        <form action="/tp/deal/save" class="form-validate" method="POST"
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between mb-5">
                    <h4 class="card-title list-link  text-[20px] mb-3">Sao chép Deal</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="manager-deal">
                                <div class="deal-group">
                                    ...
                                    <div class="content">
                                        @include('tp::deals.components.editDeal',['noEdit' =>
                                ...
                                <div class="deal-group">
                                    ...
                                    <div class="content">
                                        <div class="item-product-main" m-checkbox="PRODUCT_CHOOSES_PRODUCT_MAIN"
                                            data-action="{{ $action }}">
                                            @if ($product_mains->count() > 0)
                                            @include('tp::deals.components.itemMain',['products' =>
                                            $product_mains, 'type' => 'main','product_checked' =>
                                            $product_main_checked, 'noEdit' => $product_subs->count() > 0 ? true :
                                            false])
                                            @else
                                            @include('tp::deals.components.itemMainShow',['products' =>
                                            $product_mains, 'type' => 'main','product_checked' =>
                                ...
                                <div class="deal-group">
                                    <div
                                        class="deal-progress @if ($product_subs->count() > 0) done @elseif($product_subs->count() == 0) active @endif">
                                        <span class="number">
                                    ...
                                    <div class="content">
                                        <div class="item-product-sub" m-checkbox="PRODUCT_CHOOSES_PRODUCT_SUB"
                                            data-action="{{ $action }}">
                                            @if ($product_subs->count() > 0)
                                            @include('tp::deals.components.itemSub',['products' =>
