<div class="d-flex justify-content-between">
	<h4 class="">Thông tin cơ bản</h4> <button class="btn btn-link edit-deal @if (isset($noEdit) && $noEdit) no-edit @endif" data-id="{-currentItem.id-}" data-action="{{ $action }}">
...
<div class="info-deal">
	<div class="row">
		...
		<div class="col-lg-4">
			<p>Gian hàng: {{ $currentItem->shop->name }}</p>
		</div>
		<div class="col-lg-4">
