        ...
        <div class="rows">
            <div class="col-lg-9">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" id="name" name="name" rules="required" m-required="Vui lòng nhập tên chương trình" placeholder="Nhập tên chương trình">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-search">
                        @include(config('tpc_PromotionType')['data'][$currentItem->promotion_type_id]['search_view'])
                    </div>
                    <div class="list-result-custom @if(!$currentItem->promotion_type_id) hidden @endif border overflow-y-auto overscroll-x-hidden max-h-[500px]">
                        @include(config('tpc_PromotionType')['data'][$currentItem->promotion_type_id]['view'])
                    </div>
                </div>
                <div class="form-group">
