...
<div class="flash-sale">
    <form action="tp/flash-sale/update/{{$currentItem->id}}" method="POST" class="form-validate" plus="FLASH_SALE.checkTime" data-success="FLASH_SALE.createSuccess" absolute>
        @csrf
        <div class="rows">
            <div class="col-lg-9">
                ...
                <div class="form-group flex items-center gap-3">
                    ...
                    <div class="flash-sale-datetime">
                        @include('tp::flash_sales.components.TimeSlot',['flash_sale' => $currentItem])
                    </div>
                </div>
                <div class="form-group">
