    ...
    <table class="table-statical-line table-statical-line-border">
        <thead>
            <tr class="font-weight-bold">
                ...
                <th style="width: 100px;">Danh sách học viên</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><a href="esystem/danh-sach-hoc-vien-cua-giao-vien/{{Support::show($item,'id')}}" class="admin-btn-all" title="Xem" target="_blank">Xem</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
