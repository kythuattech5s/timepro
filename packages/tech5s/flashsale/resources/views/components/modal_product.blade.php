    ...
    <div class="form-search-item">
        ...
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <div class="search-name">
                ...
                <input type="text" class="rounded border" name="q" placeholder="Nhập từ khóa" filter="q">
            </div>
...
<div class="form-choose-product">
    <div class="modal-body">
        <table class="table">
            @include('tpf::components.modal_table_item')
        </table>
    </div>
    <div class="modal-footer">
        <span>Đã chọn<span class="mx-2 font-bold" m-checkbox-count>{{ $item_chooses->count() }}</span>sản phẩm</span>
