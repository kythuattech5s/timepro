            ...
            <div class="rows">
                <div class="col-lg-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="list-result-custom @if (!$currentItem->promotion_type_id) hidden @endif overscroll-x-hidden max-h-[250px] overflow-y-auto border">
                ...
                <div class="col-lg-3">
                    <a class="mb-4 flex gap-3 items-center text-white bg-red-500 p-2" href="tpf/flashsale/chinh-sua-chi-tiet-flash-sale?id={{ $currentItem->id }}"><i class="fa fa-edit"></i>Chỉnh sửa sản phẩm</a>
