...
class ProductCode extends ProductConditionType
{
    public function loadListItemSelecter($mapId = null)
    {
        ...
        $listItems = Product::whereDoesntHave('variants')
            ...
            ->paginate(10);
        return view('tech5spromotion::admin.product_condition.select_item.product.list_item_selecter', compact('listItems', 'code', 'name'));
    }
