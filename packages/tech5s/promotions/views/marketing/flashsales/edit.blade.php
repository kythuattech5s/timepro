...
@endsection
@section('main')
    <form action="/sys-promotion/flash_sales/update/{-currentItem.id-}" class="form-validate" method="POST"  plus="FLASH_SALE.saveProductNoActive" data-success="AJAX_PROMOTION.createSuccess" absolute>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title list-link">Sửa Flash Sale</h4>
                    </div>
                    <div class="flash-sale-group">
                        <h4>Thông tin cơ bản</h4>
                        <div class="flash-sale-group__form d-flex">
                            <label>Tên chương trình</label>
                            <input class="form-control" type="text" name="name" value="{-currentItem.name-}" placeholder="Tên chương trình">
                        </div>
                        <div class="flash-sale-group__form d-flex">
                            <label>Khung giờ Flashsale</label>
                            <div class="flash-sale-datetime d-flex">
                                @include('tech5spromotion::marketing.flashsales.timeslot',['flash_sale' => $currentItem])
                            </div>
                        </div>
                    </div>
                </div>
