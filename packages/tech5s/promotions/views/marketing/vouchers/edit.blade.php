...
<div class="row">
    <div class="col-lg-12">
        <form action="/sys-promotion/vouchers/update/{-currentItem.id-}" class="form-validate" method="POST"
            data-success="AJAX_PROMOTION.createSuccess" absolute parent=".check-parent">
            <input type="hidden" name="type" value="create">
            <input type="hidden" name="returnurl" value="{{ request()->input('returnurl') }}">
            @csrf
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="card-title list-link">Sửa Voucher</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-9">
                                        ...
                                        <div class="voucher-type">
                                            <div class="voucher-type__item position-relative">
                                                <input class="form-control" type="radio" id="type_code_shop"
                                                    ...
                                                    $currentItem->code_type == VoucherHelper::CODE_TYPE_SHOP ? 'checked'
                                                : 'disabled' }}>
                                            ...
                                            <div class="voucher-type__item position-relative">
                                                <input class="form-control" type="radio" id=type_code_product
                                                    ...
                                                    $currentItem->code_type == VoucherHelper::CODE_TYPE_PRODUCT ?
                                                'checked' : 'disabled' }}>
                                                <label for="type_code_product" class="no-edit">
                                                    <img src="{{ asset('tech5sMarketing/images/online-shopping.png') }}"
                                                        alt="Shop">
                                                    Voucher sản phẩm
                                                </label>
                                            </div>
                                    ...
                                    <div class="voucher-group__form align-items-baseline">
                                        ...
                                        <div class="voucher-code__form">
                                            <div class="voucher-code__input check-parent">
                                                <span class="voucher-code__prefix">{{ VoucherHelper::PREFIX_CODE
                                                    }}</span>
                                ...
                                <div class="voucher-group">
                                        ...
                                        <div class="voucher-saleBy">
                                            <div class="voucher-saleBy__item">
                                                <input type="radio" id="sale_by_promotion" name="voucher_type"
                                                    value="{{ VoucherHelper::VOUCHER_TYPE_PROMOTION }}" {{
                                                    $currentItem->voucher_type == VoucherHelper::VOUCHER_TYPE_PROMOTION
                                                ? 'checked' : 'disabled' }}>
                                            ...
                                            <div class="voucher-saleBy__item">
                                                <input type="radio" id="sale_by_coin" name="voucher_type"
                                                    ...
                                                    $currentItem->voucher_type == VoucherHelper::VOUCHER_TYPE_COIN ?
                                                'checked' : 'disabled' }}>
                                    ...
                                    <div class="voucher-group__form">
                                        ...
                                        <div class="voucher-discount check-parent">
                                            <select name="type_discount" id="type-discount">
                                                @if ($currentItem->voucher_type ==
                                                VoucherHelper::VOUCHER_TYPE_PROMOTION)
                                                <option value="{{ VoucherHelper::DISCOUNT_MONEY }}" {{ $currentItem->
                                                    type_discount == VoucherHelper::DISCOUNT_MONEY ? 'selected' : '' }}>
                                                    Theo số tiền
                                                </option>
                                                @endif
                                                <option value="{{ VoucherHelper::DISCOUNT_PERCENT }}" {{ $currentItem->
                                                    type_discount == VoucherHelper::DISCOUNT_PERCENT ? 'selected' : ''
                                                    }}>
                                                    Theo phần trăm
                                                </option>
                                            </select>
                                            <input type="text" class="form-control" name="fake_discount"
                                                rules="required" inputNeedFormat placeholder="Số tiền giảm"
                                            ...
                                            <div class="choose-coin__type">
                                                <div class="choose-coin__item">
                                                    <input type="radio" name="type_limit" id="choose-limit"
                                                        value="{{ VoucherHelper::VOUCHER_LIMIT }}" {{
                                                        $currentItem->max_discount !== null ? 'checked' : '' }}>
                                                    <label for="choose-limit">Giới hạn</label>
                                                </div>
                                                <div class="choose-coin__item">
                                                    <input type="radio" name="type_limit" id="choose-no-limit"
                                                        value="{{ VoucherHelper::VOUCHER_NO_LIMIT }}" {{
                                                        $currentItem->max_discount == null ? 'checked' : '' }}>
                                            ...
                                            <div class="choose-coin__footer">
                                                <div class="input-refund-limit">
                                                    <input type="text" rules="required" class="form-control"
                                                        ...
                                                        $currentItem->max_discount == null ? 'disabled' : '' }}
                                                    inputNeedFormat
                                                    ...
                                                    <span class="limit-prefix">{{ $currentItem->voucher_type ==
                                                        VoucherHelper::VOUCHER_TYPE_COIN ? 'COIN' : 'VND' }}</span>
                                                </div>
                                                <p>Tương đương:
                                                    <b>
                                                        <span class="total-coin">{{ $currentItem->max_discount !== null
                                                            ? Support::numberFormat($currentItem->max_discount) : '0'
                                                            }}</span>
                                                        <span class="prefix-money">
                                                            {{ $currentItem->voucher_type ==
                                                            VoucherHelper::VOUCHER_TYPE_COIN ? 'COIN' : 'VND' }}
                                                        </span>
                                                    </b>
                                                </p>
                                            </div>
                                    ...
                                    <div class="voucher-group__form">
                                        ...
                                        <div class="voucher-max check-parent">
                                            ...
                                            <input class="form-control" type="text" rules="required"
                                                ...
                                                name="fake_minimum_apply_voucher" inputNeedFormat
                                                value="{{ Support::numberFormat($currentItem->minimum_apply_voucher) }}">
                                            <input type="hidden" name="minimum_apply_voucher"
                                                value="{-currentItem.minimum_apply_voucher-}">
                                        </div>
                                    </div>
                                    <div class="voucher-group__form">
                                        ...
                                        <div class="voucher-type-used">
                                            <div class="group-form">
                                                <input type="radio" id="type_used_{{VoucherHelper::TYPE_USED_NULL}}"
                                                    ...
                                                    {{$currentItem->type_used == VoucherHelper::TYPE_USED_NULL ?
                                                'checked' : ''}}>
                                            ...
                                            <div class="group-form">
                                                <input type="radio"
                                                    ...
                                                    name="type_used" {{$currentItem->type_used ==
                                                VoucherHelper::TYPE_USED_AFTER_BUY_ORDER ? 'checked' : ''}}>
                                    ...
                                    <div class="voucher-group__form">
                                        ...
                                        <input name="number_satisfy" class="form-control"
                                            value={{$currentItem->number_satisfy}} placeholder="Áp dụng sau số đơn"
                                        {{$currentItem->type_used == VoucherHelper::TYPE_USED_NULL ? 'disabled' : ''}}>
                                    </div>
                                    <div class="voucher-group__form">
                                     ...
                                     <div class="voucher-group__form">
                                        ...
                                        <input name="ord" class="form-control" value="{{$currentItem->ord ?? 0}}"
                                ...
                                <div class="voucher-group footer">
                                        ...
                                        <div class="voucher-public">
                                            <div class="voucher-public__group">
                                                <input type="radio" id="voucher-public__all" name="is_public"
                                                    value="{{ VoucherHelper::TYPE_PUBLIC }}" {{ (int)
                                                    $currentItem->is_public == VoucherHelper::TYPE_PUBLIC ? 'checked' :
                                                '' }}>
                                                <label for="voucher-public__all">Toàn trang</label>
                                            </div>
                                            <div class="voucher-public__group">
                                                <input type="radio" id="voucher-public__private" name="is_public"
                                                    value="{{ VoucherHelper::TYPE_PRIVATE }}" {{ (int)
                                                    $currentItem->is_public == VoucherHelper::TYPE_PRIVATE ? 'checked' :
                                                '' }}>
                                    ...
                                    <div class="voucher-group__form apply-product align-items-baseline">
                                        ...
                                        <div class="item-product" style="display:none;">
                                            <button style="display:none" type="button" class="btn bg-green-400 text-white"
                                        ...
                                        <div class="item-product">
                                            @include('tech5spromotion::marketing.vouchers.itemShow')
                                        </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="voucher-image d-flex flex-column justify-content-center align-items-center">

                                <label for="voucher-image" class="voucher-image__title w-100 text-center"
                                    style="width:100%">Ảnh chương trình</label>
                                <img style="object-fit:cover"
                                    src="{{ !empty($currentItem->img)? FCHelper::eimg2($currentItem, 'img'): asset('tech5sMarketing/images/image-default.svg') }}">
                                <input placeholder="Thêm hình ảnh" class="form-control" value="{{ $currentItem->img }}"
                                    type="hidden" name="img" id="voucher-image">
                                <div class="form-group textcenter">
                                    <a href="{{ $admincp }}/media/view?istiny=voucher-image"
                                        class="browseimage bgmain btn bg-orange-400 iframe-btn text-white" type="button">{{
                                        trans('db::choose_img') }}</a>
                                    <button
                                        class="btnchange-voucher-image bgmain btn bg-red-400 text-white mt-[15px] ml-[5px] text-white">{{ trans('db::edit')
                                        }}</button>
                                    <button
                                        class="btndelete-voucher-image bgmain btn bg-blue-400 mt-[15px] ml-[5px]">{{ trans('db::delete')
                                        }}</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-form">
                <a class="btn bg-red-400 text-white"
                    href="{{ base64_decode(request()->input('returnurl', base64_encode(url('esystem/view/vouchers')))) }}">Back</a>
...
@include('tech5spromotion::marketing.view_edit_script')
@endsection