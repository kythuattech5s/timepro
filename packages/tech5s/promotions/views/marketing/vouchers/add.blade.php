        ...
        <form action="/sys-promotion/vouchers/create" class="form-validate" method="POST"
            ...
            <div class="card">
                <div class="card-header flex justify-between">
                    <h4 class="card-title list-link text-[20px] mb-3">Thêm Voucher</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="manager-voucher">
                                ...
                                <div class="voucher-group">
                                    ...
                                    <div class="voucher-group__form">
                                        ...
                                        <div class="voucher-max check-parent">
                                            ...
                                            <input class="form-control" type="text" rules="required"
                                                ...
                                                name="fake_minimum_apply_voucher" value="0" inputNeedFormat>
                                    ...
                                    <div class="voucher-group__form">
                                        ...
                                        <input type="text" class="form-control" placeholder="Giá trị đơn hàng từ..."  inputNeedFormat>
                        ...
                        <div class="col-lg-3">
                            <div class="voucher-image flex flex-column justify-center align-items-center">
                                <label for="voucher-image" class="voucher-image__title w-full text-center">Ảnh chương
                                    trình</label>
                                <img style="object-fit:cover"
                                    src="{{ asset('tech5sMarketing/images/image-default.svg') }}">
                                <input placeholder="Thêm hình ảnh" class="form-control" type="hidden" name="img"
                                    id="voucher-image">
