...
<div class="row margin0">
    <div class="col-xs-12">
        <p class="form-title"><?php echo e(FCHelper::er($table, 'note')); ?></p>
    </div>
    <div class="col-xs-12 box-gallery" data-variable='gallery_control_admin_<?php echo e($name); ?>'>
        <?php
            $galleriesJson = $value;
            $galleries = json_decode($galleriesJson, true);
            $galleries = is_array($galleries) ? $galleries : [];
        ?>
        <textarea class="hidden" name="<?php echo e($name); ?>" id="<?php echo e($name); ?>" data-type="GALLERY_CONTROL_ADMIN.VIEW"><?php echo $galleriesJson; ?></textarea>
        <div class="gallery_control_admin_list">
            <ul class="gallery_ul gallery_ul_<?php echo e($name); ?>">
        ...
        <div class="btnadmin">
            <a href="javascript:void(0);" class="btn gallery_ul_<?php echo e($name); ?>_add" type="button">Add 1 Image</a>
        </div>
        <div class="btnadmin">
            <a href="esystem/media/view?istiny=gallery_control_admin_<?php echo e($name); ?>&callback=GALLERY_CONTROL_ADMIN_PROVIDER.callback_multi" class="btn gallery_ul_<?php echo e($name); ?>_add_multi iframe-btn" type="button">Add Images</a>
        </div>
        <?php if(!is_null($folder)): ?>
            <div class="btnadmin">
                <a href="javascript:void(0)" class="btn add-zip" data-name="<?php echo e($name); ?>">Add Zip</a>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script type="text/javascript">
    $(function() {
        window['gallery_control_admin_<?php echo e($name); ?>'] = new GALLERY_CONTROL('<?php echo e($name); ?>');
        window['gallery_control_admin_<?php echo e($name); ?>'].init();
        <?php if(!is_null($folder)): ?>
            ...
            addZip.forEach((button) => {
                button.onclick = () => {
                    ...
                    fileUpload.onchange = (e) => {
                        ...
                        formData.append('folder', "<?php echo e($folder); ?>");
...
<?php /**PATH C:\laragon\www\dethi\/packages/vanhenry/views/ctedit/gallery_control_admin.blade.php ENDPATH**/ ?>