<header class="header py-2 lg:py-0 bg-white shadow-[0_4px_48px_rgba(0,0,0,.08)]">
    <div class="container flex justify-between lg:flex-start items-center gap-4">
        <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e(\VRoute::get("home")); ?>" title="Trang chủ" class="logo-header block shrink-0 md:max-w-[208px] max-w-[150px]">
                <?php echo $__env->make('image_loader.config.big',['config_key'=>'logo','noLazyLoad'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </a>
        </div>
        <div class="menu flex-1 justify-center flex items-center 2xl:gap-8 gap-4">
            <a href="<?php echo e(\VRoute::get("home")); ?>" title="Trang chủ" class="logo-mobile block lg:hidden text-center py-3">
                <?php echo $__env->make('image_loader.config.big',['config_key'=>'logo','noLazyLoad'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </a>
            <?php
            ...
            <span class="show-form-search cursor-pointer">
                <?php echo $__env->make('icon_svgs.icon_search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </span>
        </div>
        ...
        <div class="h-action items-center flex 2xl:-gap-8 gap-4">
            <a href="<?php echo e(\VRoute::get("viewCart")); ?>" title="Giỏ hàng" class="h-cart relative block">
                <?php echo $__env->make('icon_svgs.icon_cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <?php else: ?>
                <div class="h-auth font-semibold bg-gradient-to-r from-[#F44336] to-[#C62828] rounded-md py-2 sm:px-5 px-3 text-white">
                    ...
                    <a href="<?php echo e(\VRoute::get("login")); ?>" title="Đăng nhập" class="link">Đăng nhập</a>
                    <span class="hidden lg:inline-block">/</span>
                    <a href="<?php echo e(\VRoute::get("register")); ?>" title="Đăng ký" class="link hidden lg:inline-block">Đăng ký</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
    <div class="container block lg:hidden py-2">
        <form action="<?php echo e(\VRoute::get("search")); ?>" method="get" class="form-search-mobile relative" accept-charset="utf-8">
...
</header><?php /**PATH D:\laragon\www\timepro\resources\views/layouts/header.blade.php ENDPATH**/ ?>