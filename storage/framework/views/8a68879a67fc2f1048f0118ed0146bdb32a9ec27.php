<div class="d-flex comment-box__filter-header flex-wrap justify-content-between align-items-center">
    <p class="my-1"><span comment-count><?php echo e($comments->total()); ?></span> nhận xét</p>
...
<div class="d-flex flex-wrap align-items-center comment-box__filter-content">
    ...
    <div class="comment-filter__lists" data-table="<?php echo e($map_table); ?>" data-id="<?php echo Support::show($currentItem, 'id') ?>">
...
</div><?php /**PATH H:\laragon\www\timepro\packages\roniejisa\comment\src\Providers/../../views/comment_filter.blade.php ENDPATH**/ ?>