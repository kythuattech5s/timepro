...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo vanhenry\helpers\helpers\SettingHelper::getSettingImage('logo','img') ?>">
...
<div class="container-fluid">
  <div class="login col-xs-12 col-md-6">
    <img src="<?php echo vanhenry\helpers\helpers\SettingHelper::getSettingImage('logo','img') ?>" class="img-responsive loginlogo" alt="">
    <form class="tac" action="<?php echo e($admincp); ?>/login" method="POST">
    <?php echo csrf_field(); ?>
...
</body><?php /**PATH H:\laragon\www\timepro\packages\vanhenry\manager\src/views/login.blade.php ENDPATH**/ ?>