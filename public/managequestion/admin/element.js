var ELEMENTOR_MANAGE_QUESTION = function(clazz){

	this.currentClazz = clazz;

	this.baseurl = $('base').attr("href");

	this.admincp = 'esystem';
	...
	this.initAddItem = function(){
		...
		$('.elementor_json_field .add-'+self.currentClazz).click(function(event) {
	...
	this.initEditor = function(){
		...
		for (var i = 0; i < items.length; i++) {
			...
			var options = this.mergeArray({
			    ...
			    "save table contextmenu directionality emoticons template paste tech5sfilemanager textcolor colorpicker autoresize eqneditor"
			    ...
			    toolbar2:"formatselect fontselect fontsizeselect | link unlink table | forecolor backcolor | tech5sfilemanager | image | mathSymbols | eqneditor",
			    ...
			    external_filemanager_path:this.baseurl+this.admincp+'/media/view',
			    ...
			    file_browser_callback: function(field_name, url, type, win) {
			        ...
			        _this.fixTinymceFileManager(field_name, func_value, type, win); 
...
var ELEMENTOR_MANAGE_QUESTION_PROVIDER = (function(){
