            ...
            // try {
                ...
                // if (res.secretId) {
                    modal.innerHTML = await `
                                <div class="w-[60vw]">
                                    <iframe id="video-content-${res.tvsMapItem.id}" style="width:100%" onload="MORE_FUNCTION.resizeIframe('video-content-${res.tvsMapItem.id}')" src="/load-video?tvsMapItemId=${res.tvsMapItem.id}&poster=${res.poster}"></iframe>
                                </div>	
                            `;
